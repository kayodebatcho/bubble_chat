...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final TextEditingController passwordController = TextEditingController();
    ...
    final TextEditingController confirmePasswordController = new TextEditingController();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        height: 40.0,
            ...
            SizedBox(height: 10,),
            Center(
               child: Text('créer un compte',style: TextStyle(fontSize:20.0,color: Colors.white),),
            ),
 ...
 SizedBox(height:180.0),
            ...
            ElevatedButton(onPressed:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CodeReceve()),);
            },
            style: ButtonStyle(
