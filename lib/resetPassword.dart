import 'package:bubble_chat/inscription.dart';
...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        height: 40.0,
            ...
            SizedBox(height: 10,),
          Center(
               child: Text('fIinalisation de la création de votre compte',style: TextStyle(fontSize:16.0,color: Colors.white),),
 ...
 SizedBox(height:180.0),
            ...
            fixedSize: MaterialStateProperty.all(Size(200.0, 50.0),),
             ...
             child: Text("COMFIRMER", style: TextStyle(fontSize:17.0,color: Colors.white),)
            ),
            Text(description)
